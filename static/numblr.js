var Numblr = (function () {
  ...
  class App {
      constructor() {
          ...
          this.$end = End;
          this.$cols = [Col0, Col1, Col2];
          this.$timer = {
              $: Timer,
              toggle: Timer.querySelector('.toggle'),
              plus: Timer.querySelector('.plus'),
              minus: Timer.querySelector('.minus'),
              secs: Timer.querySelector('.secs'),
          };
          this.onScroll = debounce_1(() => {
      ...
      async showDir(dir) {
          ...
          const nextIdx = Number((_a = curbig.dataset) === null || _a === void 0 ? void 0 : _a.idx) + dir;
  ...
  App.PAGE_SIZE = __DATA__.pageSize;
  App.API_URL = __DATA__.apiUrl;
  App.ACCOUNT = __DATA__.account;
  var client = new App();
